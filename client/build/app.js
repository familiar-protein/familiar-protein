...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = (
	  React.createElement(Route, {name: "app", path: "/", handler: App}, 
	    React.createElement(Route, {name: "question", path: ":qNumber", handler: QuestionContainer}), 
	      ...
	      var questions = this.props.data.map(function(question, index) {
	        ...
	        return (
	          React.createElement("tr", {key: question.qNumber, className: "question"}, 
	            ...
	            React.createElement("td", null, React.createElement("a", {className: "btn btn-primary", onClick: this.props.goToQuestionDetail.bind(null, index), href: link}, "Solve"))
	          )
	        )
	      }.bind(this));
	      return (
